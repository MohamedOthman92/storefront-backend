...
//!!!
var _a = process.env, BCRYPT_PASSWORD = _a.BCRYPT_PASSWORD, SALTROUNDS = _a.SALTROUNDS, pepper = _a.pepper;
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot get users list ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO users (name, address, phone, password) VALUES($1, $2, $3, $4) RETURNING *';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1["default"].hashSync(u.password + pepper, parseInt(SALTROUNDS));
                        return [4 /*yield*/, conn.query(sql, [u.name, u.address, u.phone, hash])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
    ...
    UserStore.prototype.patch = function (id, u) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'UPDATE users SET name=$2 , address=$3 , phone=$4, password=$5 WHERE id=$1';
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [id, u.name, u.address, u.phone, u.password])];
                    case 2:
                        result = _a.sent();
